...
//    NOTIFICATIONS
    ...
    public static PreferenceKey BREAKFAST_NOTIFICATIN_TIME = new PreferenceKey(PrefConstants.BREAKFAST_NOTIFICATION_TIME, "");
    public static PreferenceKey LUNCH_NOTIFICATION_ACTIVE = new PreferenceKey(PrefConstants.LUNCH_NOTIFICATION_ACTIVE, false);
    public static PreferenceKey LUNCH_NOTIFICATIN_TIME = new PreferenceKey(PrefConstants.LUNCH_NOTIFICATION_TIME, "");
    public static PreferenceKey DINNER_NOTIFICATION_ACTIVE = new PreferenceKey(PrefConstants.DINNER_NOTIFICATION_ACTIVE, false);
    public static PreferenceKey DINNER_NOTIFICATIN_TIME = new PreferenceKey(PrefConstants.DINNER_NOTIFICATION_TIME, "");
    public static PreferenceKey DAY_NOTIFICATION_ACTIVE = new PreferenceKey(PrefConstants.DAY_NOTIFICATION_ACTIVE, false);
    public static PreferenceKey DAY_NOTIFICATIN_TIME = new PreferenceKey(PrefConstants.DAY_NOTIFICATION_TIME, "");
    public static PreferenceKey NIGHT_NOTIFICATION_ACTIVE = new PreferenceKey(PrefConstants.NIGHT_NOTIFICATION_ACTIVE, false);
    public static PreferenceKey NIGHT_NOTIFICATIN_TIME = new PreferenceKey(PrefConstants.NIGHT_NOTIFICATION_TIME, "");
